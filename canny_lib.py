...
def extract_etopo15(file_name, file_base = '/Users/rmendels/WorkFiles/', lat_min = 20.0020833, lat_max = 50.0020833, lon_min = -90.00208333,  lon_max = -61.0020833):
    ...
    Args:
        ...
        lon_min (float): The minimum longitude for the data extraction. Defaults to -90.00208333.
        lon_max (float): The maximum longitude for the data extraction. Defaults to -59.0020833.
...
def create_depth_gradient_nc(f_name, base_dir, depths, lats, lons):
    ...
    '''
    history = 'created from ' + f_name + 'using python scikit-image canny algorithm, sigma = 12.5'
